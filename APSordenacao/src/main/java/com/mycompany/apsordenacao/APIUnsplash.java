...
public class APIUnsplash {
    ...
    private static final String CHAVE_ACESSO = "nS4p0lU-TzBQaz3-uYNvwW4dPWbyKHDReotVpbtHzr8"; 
    
    // URL base da API Unsplash (ajuste para o endpoint correto da API)
    private static final String API_UNSPLASH = "https://api.unsplash.com/photos/random?count=1"; 
    ...
    public String pegarImagens() throws Exception {
        ...
        URL url = new URL(API_UNSPLASH + "&client_id=" + CHAVE_ACESSO);
